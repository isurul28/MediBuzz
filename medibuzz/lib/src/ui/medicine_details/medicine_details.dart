              ...
              child: Column(
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Center(
                      child: Text(
                        "Delete this MediBuzz?",      //alert box before deleting 
                        ...
                        child: InkWell(
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: Color(0xFF3EB16F),       //alert box color
      ...
      child: ListView(
        ...
        children: <Widget>[
          Text(
            ...
            style: TextStyle(
                fontSize: 17,
                color: Color(0xFFC9C9C9), //tile of medic data
                fontWeight: FontWeight.bold),
          ),
          Text(
            fieldInfo,
            style: TextStyle(
                fontSize: 24,
                color: Colors.purple, //data of medi
                fontWeight: FontWeight.bold),
          ),
        ],
      ),
